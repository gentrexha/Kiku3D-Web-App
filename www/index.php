...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60"
      style="background: url(images/BackgroundTest1.jpg); background-size: 100% 100%;background-repeat: no-repeat; ">
...
<div class="container">
    ...
    <div id="about">
        ...
        <div class="featurette">
            <img class="featurette-image img-circle img-responsive pull-right" src="images/alieni.png"
                 style="margin-top: 50px;">
            <h2 class="featurette-heading"><!-- Rreth Nesh -->
                <span class="text-muted">Lodra juaj ashtu si e keni vizatuar</span>
            </h2>
            <p class="lead" Kiku është një start-up që mirret me prodhimin e lodrave me anë të teknologjisë 3D bazuar në
               vizatime.<br> Letra gjithmonë humbet në shtëpi prandaj vizatimin e fëmijëve tuaj apo të fëmijërisë suaj
            silleni tek ne dhe ne ju kthejmë ato ne 3D.<br> A ka diçka më të mirë se sa fëmija të kalojë kohën duke
            luajtur me lodrën të cilën e ka vizatuar vet?<br> Sjell imagjinatën dhe kreativitetin tek ne, ne sjellim
            realitetin tek ju!
        </div>
    </div>
        ...
        <div class="featurette">
            ...
            <div class="row">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/OCWj5xgu5Ng" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    INPUT FORMA
    ************************************************************** -->
            <form action="" method="post" id="contact-form" class="contact-form" action="form_phpm_mailer.php"
                ...
                <div class="row">
                    ...
                    <div id="InputFormaZgjedh" class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        ...
                        <select id="FormA" class="input-field-select" name="forma" placeholder="Zgjedh"
                                oninput="Inputforma()">
                ...
                <div class="row">
                    ...
                    <div id="InputForma2" class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <input type="text" id="emriFemijes" name="emriFemijes" class="input-field"
                               placeholder="Emri i Femijes" required="required">
                    </div>
                ...
                <div class="row">
                    ...
                    <div id="InputForma3" class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <input type="text" id="emriLodres" name="emriLodres" class="input-field"
                               placeholder="Emri i Lodres" required="required">
                    </div>
                ...
                <div class="row" id="InputForma6">
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <textarea name="message" id="message" class="input-field" rows="8"
                                  placeholder="Tregimi per lodren"
                                  title="Na tregoni më shumë për këtë lodër. C'formë është, pse i ka këto ngjyra dhe forma, çfare superfuqi ka etj."></textarea>
                    </div>
                ...
                <div class="row" id="InputformaGaleri" style="display: none;">
                    <div class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <p class="input-field">Ju lutem zgjidhni njërin nga modelet gjysmë të gatshme klikoni për të
                            shkarkuar ato ngjyrosini dhe na i dërgoni ne që t'ju a sjellim lodër</p>
                    </div>
                ...
                <div class="row" id="InputForma1">
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <input required type="file" id="uploadFoto" name="uploadFoto"
                               class="btn btn-default standard-button red-button" placeholder="Upload Foton"
                               title="Ngarko foton e fëmijëve këtu në formatin .jpg .png .jpeg" style="display: none;"/>
                        <label for="uploadFoto" class="btn btn-default standard-button red-button"
                               style="width: 100%;margin-left: 0px">Ngarko foton</label>
                    </div>
                ...
                <div class="row" id="InputForma7">
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <input list="Dimensionet" class="input-field" name="Dimensionet"
                               placeholder="Zgjedh Dimensionet">
                ...
                <div class="row">
                    ...
                    <div id="InputForma8" class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <br><input type="email" id="email" name="email" class="input-field" placeholder="Emaili"
                                   title="Ku mund të ju kontaktojmë" required="required">
                    </div>
                ...
                <div class="row">
                    ...
                    <div id="InputForma9" class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <input type="text" id="adresa" name="adresa" class="input-field" placeholder="Adressa"
                               title="Ku dëshironi tju sjellim produktin" required="required">
                    </div>
                ...
                <div class="row">
                    ...
                    <div id="InputForma10" class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                        <input type="text" id="nrTelefonit" name="nrTelefonit" class="input-field"
                               placeholder="Numri i Telefonit" title="Alternativa tjetër e kontaktit">
                    </div>
                ...
                <div class="row">
                    <div id="InputForma11" class="col-sm-12 col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
                        <input style="width: 100%; margin-left: 0px" type="submit" id="submit" name="submit"
                               value="Dergo Porosine" class="btn btn-default standard-button red-button">
                    </div>
                </div>
            </form>
            <!-- ************************************************************** -->
